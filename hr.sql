...
#2
#SELECT e.first_name, e.last_name, d.department_name, l.city, l.state_province FROM employees e LEFT JOIN departments d ON d.department_id = e.department_id 
...
#5
#SELECT e.first_name, e.last_name, d.department_name, l.city, l.state_province FROM employees e JOIN departments d ON d.department_id = e.department_id JOIN locations l ON d.location_id = l.location_id
#WHERE e.first_name like '%z%';

#6
#SELECT e.first_name, e.last_name, e.department_id, d.department_name FROM employees e RIGHT JOIN departments d ON e.department_id = d.department_id;

#7
#SELECT first_name, last_name, salary FROM employees WHERE salary <(SELECT salary FROM employees WHERE employee_id = 182); 
#trudniejsza
#SELECT e.first_name, e.last_name, e.salary FROM employees e JOIN employees ee ON e.salary < ee.salary WHERE ee.employee_id = 182; 

#8
#SELECT e.first_name AS 'Pracownik Name', m.first_name AS 'Szef Name' FROM employees e JOIN employees m ON e.manager_id = m.employee_id;

#13
#SELECT j.job_title, d.department_name, e.first_name, e.last_name, start_date FROM job_history jh JOIN jobs j USING(job_id)
#JOIN departments d USING (department_id) JOIN employees e USING(employee_id) WHERE jh.start_date >="1990-01-01"
#AND jh.start_date <= "1997-07-31";
...
#16
#SELECT country_name, city, COUNT(department_id) AS 'Ilość departamentów' FROM countries JOIN locations USING(country_id) JOIN departments USING(location_id) 
